...
def test_convergence_nn_dose_tilt_weight_dose_mask(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn convergence_nn {output_dir}/nn_classE_sim_dosetiltweightmask data/10076_classE_32.mrc --fsc-mask none')


def test_convergence_nn_dose_tilt_weight_dose_mask_mask_sphere(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn convergence_nn {output_dir}/nn_classE_sim_dosetiltweightmask data/10076_classE_32.mrc --fsc-mask sphere')


def test_convergence_nn_dose_tilt_weight_dose_mask_mask_tight(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn convergence_nn {output_dir}/nn_classE_sim_dosetiltweightmask data/10076_classE_32.mrc --fsc-mask tight')


def test_convergence_nn_dose_tilt_weight_dose_mask_mask_soft(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn convergence_nn {output_dir}/nn_classE_sim_dosetiltweightmask data/10076_classE_32.mrc --fsc-mask soft')
...
def test_convergence_vae_zdim2(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn convergence_vae {output_dir}/vae_both_sim_zdim2 --random-seed 42 --final-maxima 2 --ground-truth data/10076_class*_32.mrc')


def test_convergence_vae_dose_tilt_weight_dose_mask_batchsize8(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn convergence_vae {output_dir}/vae_both_sim_zdim8_dosetiltweightmask_batchsize8 --random-seed 42 --final-maxima 2 --ground-truth data/10076_class*_32.mrc')
...
def test_analyze_zdim2(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn analyze {output_dir}/vae_both_sim_zdim2 --ksample 20')


def test_analyze_dose_tilt_weight_dose_mask_batchsize8(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn analyze {output_dir}/vae_both_sim_zdim8_dosetiltweightmask_batchsize8 --ksample 20')


def test_analyze_zdim8(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn analyze {output_dir}/vae_classE_sim_zdim8 --ksample 20')
...
def test_eval_vol(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn eval_vol --weights {output_dir}/vae_both_sim_zdim2/weights.pkl -c {output_dir}/vae_both_sim_zdim2/config.pkl -o {output_dir}/vae_both_sim_zdim2/eval_vol_allz --zfile {output_dir}/vae_both_sim_zdim2/z.train.pkl')


def test_eval_vol_batchsize32(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn eval_vol --weights {output_dir}/vae_both_sim_zdim2/weights.pkl -c {output_dir}/vae_both_sim_zdim2/config.pkl -o {output_dir}/vae_both_sim_zdim2/eval_vol_allz --zfile {output_dir}/vae_both_sim_zdim2/z.train.pkl -b 32')
...
def test_analyze_volumes(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn analyze_volumes --voldir {output_dir}/vae_both_sim_zdim2/eval_vol_allz --config {output_dir}/vae_both_sim_zdim2/config.pkl --outdir {output_dir}/vae_both_sim_zdim2/eval_vol_allz_analyze_volumes_mask_sphere --ksample 20 --mask sphere')


def test_analyze_volumes_mask_soft(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn analyze_volumes --voldir {output_dir}/vae_both_sim_zdim2/eval_vol_allz --config {output_dir}/vae_both_sim_zdim2/config.pkl --outdir {output_dir}/vae_both_sim_zdim2/eval_vol_allz_analyze_volumes_mask_soft --ksample 20 --mask soft')
...
def test_subtomo2chimerax_mode_markers(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn subtomo2chimerax data/10076_both_32_sim_vols.star --mode markers --outdir {output_dir}/vae_both_sim_zdim8_dosetiltweightmask_batchsize8/mapback_markers --tomoname both.tomostar --star-angpix-override 10 --coloring-labels data/ptcl_labels_D0_E1.pkl')


def test_subtomo2chimerax_mode_volume(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn subtomo2chimerax data/10076_both_32_sim_vols.star --mode volume --outdir {output_dir}/vae_both_sim_zdim8_dosetiltweightmask_batchsize8/mapback_volume --tomoname both.tomostar --star-angpix-override 10 --vol-path {output_dir}/backproject/classE_sim_doseweight.mrc --vol-render-level 0.7 --coloring-labels data/ptcl_labels_D0_E1.pkl')


def test_subtomo2chimerax_mode_volumes(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn subtomo2chimerax data/10076_both_32_sim_vols.star --mode volumes --outdir {output_dir}/vae_both_sim_zdim8_dosetiltweightmask_batchsize8/mapback_volumes --tomoname both.tomostar --star-angpix-override 10 --weights {output_dir}/vae_both_sim_zdim8_dosetiltweightmask_batchsize8/weights.39.pkl --config {output_dir}/vae_both_sim_zdim8_dosetiltweightmask_batchsize8/config.pkl --zfile {output_dir}/vae_both_sim_zdim8_dosetiltweightmask_batchsize8/z.39.train.pkl --vol-render-level 0.7 --coloring-labels data/ptcl_labels_D0_E1.pkl')


def test_subtomo2chimerax_cmap_tab10(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn subtomo2chimerax data/10076_both_32_sim_vols.star --mode volumes --outdir {output_dir}/vae_both_sim_zdim8_dosetiltweightmask_batchsize8/mapback_volumes_cmaptab10 --tomoname both.tomostar --star-angpix-override 10 --weights {output_dir}/vae_both_sim_zdim8_dosetiltweightmask_batchsize8/weights.39.pkl --config {output_dir}/vae_both_sim_zdim8_dosetiltweightmask_batchsize8/config.pkl --zfile {output_dir}/vae_both_sim_zdim8_dosetiltweightmask_batchsize8/z.39.train.pkl --vol-render-level 0.7 --coloring-labels data/ptcl_labels_D0_E1.pkl --colormap tab10')
...
def test_filter_star_tiltseriesstarfile(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn filter_star data/10076_both_32_sim.star --starfile-type imageseries --tomo-id-col _rlnImageName --ind data/ind_ptcl_first10last10.pkl -o {output_dir}/10076_both_32_sim_filtered.star')


def test_filter_star_volumeseriesstarfile(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn filter_star data/10076_both_32_sim_vols.star --starfile-type volumeseries --tomo-id-col _rlnImageName --ind data/ind_ptcl_first10last10.pkl -o {output_dir}/10076_both_32_sim_vols_filtered.star')


def test_filter_star_tiltseriesstarfile_labels(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn filter_star data/10076_both_32_sim.star --starfile-type imageseries --tomo-id-col _rlnImageName --labels data/labels_D-0_E-1.pkl --labels-sel 0 -o {output_dir}/10076_both_32_sim_filtered_by_labels.star')


def test_filter_star_volumeseriesstarfile_labels(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn filter_star data/10076_both_32_sim_vols.star --starfile-type volumeseries --tomo-id-col _rlnImageName --labels data/labels_D-0_E-1.pkl --labels-sel 0 1 -o {output_dir}/10076_both_32_sim_vols_filtered_by_labels.star')
...
def test_graph_traversal(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn graph_traversal {output_dir}/vae_both_sim_zdim2/z.39.train.pkl --anchors 5 10 15 20 -o {output_dir}/vae_both_sim_zdim2/graph_traversal --max-neighbors 20 --avg-neighbors 20')


def test_graph_traversal_zdim8(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn graph_traversal {output_dir}/vae_both_sim_zdim8_dosetiltweightmask_batchsize8/z.39.train.pkl --anchors 5 10 15 20 -o {output_dir}/vae_both_sim_zdim8_dosetiltweightmask_batchsize8/graph_traversal --max-neighbors 20 --avg-neighbors 10')
...
def test_pc_traversal(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn pc_traversal {output_dir}/vae_both_sim_zdim2/z.train.pkl -o {output_dir}/vae_both_sim_zdim2/pc_traversal')


def test_pc_traversal_percentile_spacing(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn pc_traversal {output_dir}/vae_both_sim_zdim2/z.train.pkl -o {output_dir}/vae_both_sim_zdim2/pc_traversal --use-percentile-spacing')


def test_pc_traversal_zdim8(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn pc_traversal {output_dir}/vae_both_sim_zdim8_dosetiltweightmask_batchsize8/z.train.pkl -o {output_dir}/vae_both_sim_zdim8_dosetiltweightmask_batchsize8/pc_traversal --use-percentile-spacing')
...
def test_view_config(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn view_config {output_dir}/vae_both_sim_zdim2')
...
def test_cleanup_dryrun(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn cleanup {output_dir}/vae_classE_sim_zdim8 --weights --zfiles --volumes --test')


def test_cleanup_delete(script_runner, output_dir):
    run_assert_no_error(script_runner, command=f'tomodrgn cleanup {output_dir}/vae_classE_sim_zdim8 --weights --zfiles --volumes')
