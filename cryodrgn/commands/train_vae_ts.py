...
def main(args):
    ...
    flog(f'Pixels per particle for encoder (after encoder mask): {in_dim}')
    ...
    if args.skip_zeros_decoder:
        ...
        flog(f'Pixels per particle for decoder (after fourier circular mask):  {Ntilts * lattice_mask.sum()}')
