...
def main(args):
    ...
    if args.lazy:
        ...
        data = dataset.MRCData(args.particles, norm=args.norm, invert_data=args.invert_data, ind=ind, window=args.window, datadir=args.datadir, relion31=args.relion31, window_r=args.window_r, max_threads=args.max_threads)
    D = data.D
    Nimg = data.N
